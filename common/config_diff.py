...
from common.config_parser import _Config as Config
from common.config_parser import parse_configs
from common.iterable_ext import filter_split
...
class _Comparison(object):
    ...
    def __str__(self):
        len_k = len(self.k)
        return "{} = {}\n" "{} = {}".format(
            self.k, self.value_a, " " * len_k, self.value_b
        )
